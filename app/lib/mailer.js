...
export async function sendMail({ subject, message, email , name  }) {
														...
														<tr>
															<td class="pad" style="width:100%;">
																<div class="alignment" align="center">
																	<div style="max-width: 500px;"><img src="https://ee6224391d.imgdist.com/pub/bfra/ys986fkj/3gx/qlt/im1/hello-welcome-letters-word-2015466.jpg" style="display: block; height: auto; border: 0; width: 100%;" width="500" alt title height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
															...
															<td class="pad">
																<div style="margin-left:-20px">
																	<ul start="1" style="margin-top: 0; margin-bottom: 0; list-style-type: revert;">
																		<li style="Margin: 0 0 0 0;">Name: ${name}</li>
                                    <li style="Margin: 0 0 0 0;">Email: ${email}</li>
                                    <li style="Margin: 0 0 0 0;">Subject: ${subject}</li>
